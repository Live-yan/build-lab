...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Start_dateTimeEdit.setDateTime(QtCore.QDateTime(QtCore.QDate(2025, 9, 10), QtCore.QTime(12, 0, 0)))
        ...
        self.label_8.setGeometry(QtCore.QRect(10, 70, 121, 20))
        ...
        self.End_dateTimeEdit.setDateTime(QtCore.QDateTime(QtCore.QDate(2025, 9, 10), QtCore.QTime(12, 1, 0)))
        ...
        self.Download_pushButton.setGeometry(QtCore.QRect(150, 110, 101, 31))
        ...
        self.Download_progressBar.setGeometry(QtCore.QRect(20, 150, 241, 23))
        ...
        self.downloadType_comboBox = QtWidgets.QComboBox(self.groupBox_3)
        self.downloadType_comboBox.setEnabled(False)
        self.downloadType_comboBox.setGeometry(QtCore.QRect(10, 110, 131, 22))
        self.downloadType_comboBox.setObjectName("downloadType_comboBox")
        self.downloadType_comboBox.addItem("")
        self.downloadType_comboBox.addItem("")
        self.downloadType_comboBox.addItem("")
        self.downloadType_comboBox.addItem("")
        self.downloadType_comboBox.addItem("")
        ...
        self.downloadType_comboBox.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.downloadType_comboBox.setItemText(0, _translate("MainWindow", "不转码（normal）"))
        self.downloadType_comboBox.setItemText(1, _translate("MainWindow", "私有码流(Private)"))
        self.downloadType_comboBox.setItemText(2, _translate("MainWindow", "国标PS码流(PS)"))
        self.downloadType_comboBox.setItemText(3, _translate("MainWindow", "TS码流(TS)"))
        self.downloadType_comboBox.setItemText(4, _translate("MainWindow", "MP4"))
        self.downloadType_comboBox.setItemText(5, _translate("MainWindow", "裸视频流(H264)"))
        self.downloadType_comboBox.setItemText(6, _translate("MainWindow", "流式FLV"))
        self.downloadType_comboBox.setItemText(7, _translate("MainWindow", "PS码流(PS)"))
        self.downloadType_comboBox.setItemText(8, _translate("MainWindow", "DHTS"))
        self.downloadType_comboBox.setItemText(9, _translate("MainWindow", "CDJFPS"))
